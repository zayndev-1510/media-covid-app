...
public class ProfilUser extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profil_pengguna);
        ...
        noper=findViewById(R.id.nomor_handphone_pengguna);
        alamat=findViewById(R.id.alamat_pengguna);
        circleImageView=findViewById(R.id.image_pengguna);
        nama_lengkap=findViewById(R.id.nama_lengkap_pengguna);
        ...
        keluar_akun.setOnClickListener(v->{
            ...
            edit.clear();
            edit.apply();
            startActivity(new Intent(ProfilUser.this,Welcome.class));
        });
        ...
        @SuppressLint("NotifyDataSetChanged") StringRequest stringRequest=
                ...
                response -> {
                    try {
                        ...
                        String url="";
                        String foto=jsonObject.getString("foto_profil");
                        if(foto.equals("default.png")){
                           url=getString(R.string.ipgeneral)+"akun/default.png";
                        }
                        else{
                            url=getString(R.string.ipgeneral)+"akun/"+jsonObject.getString("id")+"/"+jsonObject.getString("foto_profil");
                        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ProfilUser.this,Home.class));
    }
}
